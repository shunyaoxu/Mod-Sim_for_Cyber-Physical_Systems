...
model PumpSystemIV
  ...
  ThermostatValve                   thermostatValve(
    redeclare package Medium = Modelica.Media.Water.ConstantPropertyLiquidWater)
  ...
  Workshop5.SolarCollector solarCollector(
    ...
    A=500,
    Tamb=288.15) annotation (Placement(transformation(extent={{-110,-22},{-90,-2}})));
equation
  ...
  connect(thermostatValve.port_a, tank.ports[2]) annotation (Line(points={{24,-30},{4,-30},{4,-4}}, color={0,127,255}));
  connect(thermostatValve.port_b, boundary1.ports[1])
    annotation (Line(points={{44,-30},{92,-30},{92,-50},{86,-50}}, color={0,127,255}));
