within CourseExamples.Workshop16;
model Engine1b "Model of one cylinder engine with gas force and preparation for assembly joint JointRRP"
  extends Modelica.Icons.Example;
  extends Modelica.Mechanics.MultiBody.Examples.Loops.Utilities.Engine1bBase(world(enableAnimation=false));
  ...
  Modelica.Mechanics.MultiBody.Joints.Prismatic cylinder(
    ...
    n={0,-1,0}) annotation (Placement(transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=270)));
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation rod1(r={0,-0.2,0}, animation=false)
    annotation (Placement(transformation(
        origin={70,-20},
        extent={{10,-10},{-10,10}},
        rotation=90)));
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation rod3(r={0,-0.1,0}, animation=false)
    annotation (Placement(transformation(
        origin={50,40},
        extent={{10,-10},{-10,10}},
        rotation=90)));
