...
model InverseModelSine
  ...
  Modelica.Blocks.Math.InverseBlockConstraints inverseBlockConstraints
    annotation (Placement(transformation(
        ...
        rotation=180,
        origin={-29,30})));
  Modelica.Blocks.Sources.Sine sine annotation (Placement(transformation(extent={{26,40},{46,60}})));
equation
  ...
  connect(sine.y, inverseBlockConstraints.u1) annotation (Line(points={{47,50},{56,50},{56,30},{29.3,30}}, color={0,0,127}));
