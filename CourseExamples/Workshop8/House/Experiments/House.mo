...
model House
  Rooms.Room house annotation (Placement(transformation(extent={{32,-16},{64,16}})));
...
equation
  ...
  connect(outTemp.port, house.wallPort) annotation (Line(points={{0,0},{32,0}}, color={191,0,0}));
  annotation (
