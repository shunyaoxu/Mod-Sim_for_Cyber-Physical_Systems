...
model ElectroMagneticPositioning
  ...
  Modelica.Mechanics.Translational.Components.Mass mass(
    ...
    v(start=0, fixed=true)) annotation (Placement(transformation(extent={{40,30},{60,50}})));
  ...
  Modelica.Magnetic.FluxTubes.Shapes.Force.HollowCylinderRadialFlux flux(
    ...
    annotation (Placement(transformation(
        ...
        rotation=-90,
        origin={0,40})));
  Modelica.Magnetic.FluxTubes.Sources.ConstantMagneticPotentialDifference magnetic(V_m=10)
  ...
  Modelica.Magnetic.FluxTubes.Basic.ElectroMagneticConverter coil(N=100)
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-30,10})));
  Modelica.Electrical.Analog.Sources.PulseVoltage voltage(
    V=3,
    width=20,
    period=0.2,
    offset=0,
  ...
  Modelica.Electrical.Analog.Basic.Resistor coilResistance(R=0.01)
...
equation
  ...
  connect(flux.port_p, coil.port_n) annotation (Line(points={{0,30},{0,20},{-20,20}}, color={255,127,0}));
  connect(coil.port_p, magneticground.port) annotation (Line(points={{-40,20},{-60,20},{-60,10}}, color={255,127,0}));
  connect(coil.n, electricalground.p) annotation (Line(points={{-20,0},{-20,-58}}, color={0,0,255}));
  connect(coilResistance.n, electricalground.p) annotation (Line(points={{-30,-50},{-20,-50},{-20,-58}}, color={0,0,255}));
  connect(coilResistance.p, voltage.n) annotation (Line(points={{-50,-50},{-60,-50},{-60,-40}}, color={0,0,255}));
  connect(voltage.p, coil.p) annotation (Line(points={{-60,-20},{-60,-8},{-40,-8},{-40,0}}, color={0,0,255}));
  annotation (
