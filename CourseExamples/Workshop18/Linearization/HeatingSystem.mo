...
partial model HeatingSystem "Simple model of a heating system"
  ...
  Modelica.Fluid.Machines.ControlledPump pump(
    ...
    p_b_start=130000,
    p_a_nominal=110000,
    p_b_nominal=130000) annotation (Placement(transformation(extent={{-50,10},{-30,30}})));
  ...
  Modelica.Fluid.Pipes.DynamicPipe heater(
    ...
    p_a_start=130000) annotation (Placement(transformation(extent={{30,10},{50,30}})));
  ...
  Modelica.Fluid.Pipes.DynamicPipe radiator(
    ...
    state_b(p(start=110000))) annotation (Placement(transformation(extent={{20,-80},{0,-60}})));
