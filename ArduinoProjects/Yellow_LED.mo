...
model Yellow_LED "Light emitting diode with animation"
...
equation
  ...
  annotation (Icon(graphics={
        Ellipse(
          extent={{-60,60},{60,-60}},
          fillColor=DynamicSelect({204,204,0}, if mean.y > 0 then {(mean.y/0.02)*275,(mean.y/0.02)*275,51} else {204,204,0}),
